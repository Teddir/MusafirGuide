    ...
    <div class="min-h-screen bg-gray-50 dark:bg-slate-950 p-4 md:p-8 transition-colors">
      <div class="max-w-4xl mx-auto">
        ...
        <div class="flex items-center gap-4 mb-8">
          ...
          <h1 class="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white">Perbandingan Mazhab</h1>
        </div>
            ...
            <table class="w-full text-left border-collapse">
              <thead>
                <tr class="bg-gray-50 dark:bg-slate-800/50 border-b border-gray-100 dark:border-slate-800">
                  <th class="p-4 font-semibold text-gray-600 dark:text-gray-400 text-sm">Mazhab</th>
                  <th class="p-4 font-semibold text-gray-600 dark:text-gray-400 text-sm">Jarak Min.</th>
                  <th class="p-4 font-semibold text-gray-600 dark:text-gray-400 text-sm">Batas Menetap</th>
                  <th class="p-4 font-semibold text-gray-600 dark:text-gray-400 text-sm">Hukum Jamak</th>
                  <th class="p-4 font-semibold text-gray-600 dark:text-gray-400 text-sm">Hukum Qasar</th>
                  <th class="p-4 font-semibold text-gray-600 dark:text-gray-400 text-sm">Referensi</th>
                </tr>
              </thead>
              <tbody>
                <tr *ngFor="let m of mazhabList" class="hover:bg-gray-50/50 dark:hover:bg-slate-800/50 transition-colors border-b border-gray-100 dark:border-slate-800 last:border-0">
                  ...
                  <td class="p-4 text-gray-600 dark:text-gray-300">{{ m.stay_duration_days }} Hari</td>
                  <td class="p-4">
                    <span [class.bg-green-100]="m.allow_jamak_taqdim" [class.text-green-700]="m.allow_jamak_taqdim" 
                      ...
                      {{ m.allow_jamak_taqdim ? 'Boleh' : 'Terbatas' }}
                    </span>
                  </td>
                  <td class="p-4">
        ...
        <div class="mt-6 bg-blue-50 dark:bg-blue-900/20 border border-blue-100 dark:border-blue-900/30 rounded-xl p-6">
            <h3 class="font-bold text-blue-900 dark:text-blue-200 mb-2">Mengapa Berbeda?</h3>
        ...
        <div class="mt-8 space-y-6">
            <h2 class="text-xl font-bold text-gray-900 dark:text-white">Pertanyaan Umum (FAQ)</h2>
            
            <div class="space-y-4">
                <div class="bg-white dark:bg-slate-900 rounded-xl p-6 shadow-sm border border-gray-100 dark:border-slate-800">
                    <h3 class="font-bold text-gray-900 dark:text-gray-100 mb-2">Bagaimana jarak dihitung?</h3>
                ...
                <div class="bg-white dark:bg-slate-900 rounded-xl p-6 shadow-sm border border-gray-100 dark:border-slate-800">
                    <h3 class="font-bold text-gray-900 dark:text-gray-100 mb-2">Apakah menetap 3 hari masih boleh Qasar?</h3>
                    <p class="text-gray-600 dark:text-gray-400 text-sm leading-relaxed">
            ...
            <div class="bg-amber-50 dark:bg-amber-900/20 border-l-4 border-amber-500 p-6 rounded-r-xl">
                <div class="flex items-start gap-4">
                    ...
                    <div>
                        <h3 class="font-bold text-amber-900 dark:text-amber-200 mb-1">Penyangkalan (Disclaimer)</h3>
                        <p class="text-amber-800 dark:text-amber-300 text-sm leading-relaxed">
                            Aplikasi ini hanyalah <strong>alat bantu</strong> dan <strong>belum tersertifikasi oleh lembaga fatwa manapun</strong>. 
                            Hasil perhitungan jarak dan status safar di sini tidak bersifat mengikat secara hukum syarak. 
                        </p>
                        <ul class="list-disc list-inside mt-2 ml-1 text-amber-800 dark:text-amber-300 text-sm">
                            <li>Konsultasi dengan ulama/ustadz terpercaya untuk kasus spesifik.</li>
                            <li>Menggunakan kehati-hatian (ihtiyat) dalam beribadah.</li>
                        </ul>
                        <p class="text-amber-800 dark:text-amber-300 text-sm leading-relaxed mt-2">
